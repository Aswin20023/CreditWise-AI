...
export default function BatchTable({ results = [] }) {
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div>
            ...
            <p className="mt-1 text-slate-500">
              {filteredResults.length} Customers
            </p>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              onClick={() =>
                exportBatchPDF(filteredResults)
              }
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-slate-800 px-4 py-2 text-white"
            >
              <RefreshCw size={18} />
              Reset
            </button>
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-300 py-3 pl-11 pr-4 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
            />
          ...
          <thead className="sticky top-0 bg-slate-100">
            ...
            <tr className="border-b border-slate-200 text-left text-sm uppercase tracking-wide text-slate-700">
              ...
              <th
                className="cursor-pointer px-6 py-4"
                onClick={() =>
                  handleSort("probability_default")
                }
              >
                Probability
            ...
            {currentRows.length === 0 ? (
              ...
              currentRows.map((row, index) => {
                ...
                return (
                  ...
                  <tr
                    key={index}
                    className="border-b border-slate-100 even:bg-slate-50 hover:bg-blue-50"
                  >
      ...
      <div className="border-t bg-slate-50 p-5 lg:hidden">
      ...
      <div className="border-t bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white">
        ...
        <div className="grid grid-cols-2 gap-6 p-6 xl:grid-cols-4">
          ...
          {[
            ...
            return (
              ...
              >
                ...
                <h2
                  className={`mt-2 text-4xl font-bold ${item.text}`}
                >
                  {count}
                </h2>

                <p className={`mt-2 text-sm ${item.text}`}>
                  {percent}%
                </p>
              </div>
            );
